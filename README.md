...
This demo project was scaffolded through [aaa-create-react-app-typescript@vv2.7.0](https://github.com/majodev/aaa-create-react-app-typescript), a customized react template project generator for [at all about apps](https://allaboutapps.at) using the preferred default settings from [Mario Ranftl](https://github.com/majodev).
